...
// -- ints --
	...
	GD_INT_INIT(APPROACH_WAR_DISPUTE_LEVEL_WEAK, 5),
	GD_INT_INIT(APPROACH_WAR_DISPUTE_LEVEL_STRONG, 15),
	GD_INT_INIT(APPROACH_WAR_DISPUTE_LEVEL_FIERCE, 30),
#endif
	...
	m_iPEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_NONE(0),
	m_iPEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_MINOR(10),
	m_iPEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_MAJOR(20),
	m_iPEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_SERIOUS(50),
	m_iPEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_CRIPPLED(80),
#endif
	...
	GD_INT_INIT(DEFENSIVE_PACT_MILITARY_STRENGTH_FACTOR, 20),
	GD_INT_INIT(THIRD_PARTY_WAR_MILITARY_STRENGTH_FACTOR, 60),
#endif
	...
	GD_INT_INIT(UNIT_EMBARK_PENALTY, -33),
#endif
#ifdef RAI_NO_MELEE_SUICIDE
	GD_INT_INIT(BASE_MELEE_DAMAGE_RECKLESSNESS, 70),
	GD_INT_INIT(MELEE_DAMAGE_RECKLESSNESS_PER_WAR_STATE, 7),
#endif
...
#ifdef RAI_AI_TRIES_TO_STOP_WIN_CONDITIONS
	GD_INT_CACHE(APPROACH_WAR_DISPUTE_LEVEL_WEAK);
	GD_INT_CACHE(APPROACH_WAR_DISPUTE_LEVEL_STRONG);
	GD_INT_CACHE(APPROACH_WAR_DISPUTE_LEVEL_FIERCE);
#endif
...
#ifdef RAI_DAMAGE_DEALT_PEACE_CHANGE
	GD_INT_CACHE(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_NONE);
	GD_INT_CACHE(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_MINOR);
	GD_INT_CACHE(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_MAJOR);
	GD_INT_CACHE(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_SERIOUS);
	GD_INT_CACHE(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_CRIPPLED);
#endif
...
#ifdef RAI_DEALS_CONSIDER_MILITARY_STRENGTH
	GD_INT_CACHE(DEFENSIVE_PACT_MILITARY_STRENGTH_FACTOR);
	GD_INT_CACHE(THIRD_PARTY_WAR_MILITARY_STRENGTH_FACTOR);
#endif
...
#ifdef RBM_UNIT_EMBARK_PENALTY
	GD_INT_CACHE(UNIT_EMBARK_PENALTY);
#endif
#ifdef RAI_NO_MELEE_SUICIDE
	GD_INT_CACHE(BASE_MELEE_DAMAGE_RECKLESSNESS);
	GD_INT_CACHE(MELEE_DAMAGE_RECKLESSNESS_PER_WAR_STATE);
#endif
