...
public:
	...
	GD_INT_DEF(APPROACH_WAR_DISPUTE_LEVEL_WEAK)
	GD_INT_DEF(APPROACH_WAR_DISPUTE_LEVEL_STRONG)
	GD_INT_DEF(APPROACH_WAR_DISPUTE_LEVEL_FIERCE)
#endif
	...
	GD_INT_DEF(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_NONE)
	GD_INT_DEF(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_MINOR)
	GD_INT_DEF(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_MAJOR)
	GD_INT_DEF(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_SERIOUS)
	GD_INT_DEF(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_CRIPPLED)
#endif
	...
	GD_INT_DEF(DEFENSIVE_PACT_MILITARY_STRENGTH_FACTOR)
	GD_INT_DEF(THIRD_PARTY_WAR_MILITARY_STRENGTH_FACTOR)
#endif
	...
	GD_INT_DEF(UNIT_EMBARK_PENALTY)
#endif
#ifdef RAI_NO_MELEE_SUICIDE
	GD_INT_DEF(BASE_MELEE_DAMAGE_RECKLESSNESS)
	GD_INT_DEF(MELEE_DAMAGE_RECKLESSNESS_PER_WAR_STATE)
#endif
...
#ifdef RAI_AI_TRIES_TO_STOP_WIN_CONDITIONS
	GD_INT_DECL(APPROACH_WAR_DISPUTE_LEVEL_WEAK);
	GD_INT_DECL(APPROACH_WAR_DISPUTE_LEVEL_STRONG);
	GD_INT_DECL(APPROACH_WAR_DISPUTE_LEVEL_FIERCE);
#endif
...
#ifdef RAI_DAMAGE_DEALT_PEACE_CHANGE
	GD_INT_DECL(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_NONE);
	GD_INT_DECL(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_MINOR);
	GD_INT_DECL(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_MAJOR);
	GD_INT_DECL(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_SERIOUS);
	GD_INT_DECL(PEACE_WILLINGNESS_OFFER_WAR_DAMAGE_DEALT_CRIPPLED);
#endif
...
#ifdef RAI_DEALS_CONSIDER_MILITARY_STRENGTH
	GD_INT_DECL(DEFENSIVE_PACT_MILITARY_STRENGTH_FACTOR);
	GD_INT_DECL(THIRD_PARTY_WAR_MILITARY_STRENGTH_FACTOR);
#endif
...
#ifdef RBM_UNIT_EMBARK_PENALTY
	GD_INT_DECL(UNIT_EMBARK_PENALTY);
#endif
#ifdef RAI_NO_MELEE_SUICIDE
	GD_INT_DECL(BASE_MELEE_DAMAGE_RECKLESSNESS);
	GD_INT_DECL(MELEE_DAMAGE_RECKLESSNESS_PER_WAR_STATE);
#endif
